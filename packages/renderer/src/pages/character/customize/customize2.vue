<script lang="tsx">
  ...
  export default defineComponent({
    async setup() {
      ...
      function alternative_list(id: ID, type = 0) {
            ...
            <div class=" w-full">
              ...
              <div class="flex h-142  w-full">
                ...
                <div class="h-full bg-hex-0d0d0d w-75% s-left">
                  ...
                  <div class="flex flex-col h-89% w-50% overflow-y-auto !max-w-50%" style="border-right:1px solid #303030">
                    <div>
                            ...
                            <>
                              ...
                              <div class={["transition-all", "ease-out-in", "h-auto", "overflow-hidden"].concat(!colspans.value[index] ? [""] : ["max-h-0"])}>
                                {renderList(alternative, item => {
                                  ...
                                  return (
                                    <div class="m-5px ml-10px mr-10px h-auto" onClick={chooseProp()}>
                                      <div class="flex items-center w-100%">
                                        <calc-checkbox class="!h-auto" disabled={disabled.value} onClick={chooseProp()}>
                                          {() => (
                                            <>
                                              ...
                                              {renderList(entry_info?.props, prop => (
                                                <div class="ml-10px mt-5px text-hex-b1a785">{prop}</div>
                                              ))}
                                            </>
                                          )}
                                        </calc-checkbox>
