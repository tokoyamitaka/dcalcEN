...
class 技能13(主动技能):
    ...
    # 暂定这样 后面继续测试修改
    data1 = [int(((i*1.051*8)**2)) for i in [0,149, 165, 180, 195, 210, 230, 245, 260, 275, 290, 305, 320, 335, 355, 365, 385, 400, 415, 430, 445, 460, 475, 490, 510, 525, 540, 555, 570, 585, 600, 615, 630, 645, 665, 680, 695, 710, 725, 740, 755, 770, 785, 805, 820, 835, 850, 865, 880, 895, 910, 925, 945, 960, 975, 990, 1005, 1020, 1035, 1050, 1070, 1085, 1100, 1115, 1130, 1145, 1160, 1175, 1190, 1205, 1225]]
    hit1 = 0
    # 光 感电
