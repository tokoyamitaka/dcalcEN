...
class 技能0(主动技能):
    ...
    MP = [16, 161]
    # 斩击攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 1034, 1138, 1243, 1348, 1454, 1559, 1663, 1768, 1873, 1979, 2082, 2188, 2294, 2398, 2504, 2607, 2713, 2818, 2923, 3029, 3132, 3238, 3343, 3448, 3553, 3658, 3763, 3868, 3973, 4077, 4183, 4287,
    ...
    hit0 = 1
    # 能量多段攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 175, 193, 211, 229, 246, 266, 284, 302, 319, 337, 355, 373, 392, 409, 427, 445, 463, 480, 498, 516, 534, 553, 570, 588, 606, 624, 641, 659, 677, 697, 715, 732, 750, 768,
...
class 技能1(主动技能):
    ...
    MP = [23, 241]
    # 波动攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 383, 424, 462, 501, 541, 579, 618, 658, 698, 735, 775, 814, 855, 892, 932, 971, 1008, 1048, 1088, 1128, 1166, 1205, 1244, 1285, 1323, 1362, 1401, 1439,
    ...
    hit0 = 1
    # 源能波攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 545, 600, 657, 712, 767, 824, 879, 934, 990, 1045, 1100, 1157, 1213, 1268, 1324, 1380, 1434, 1490, 1545, 1600, 1656, 1711, 1767, 1824, 1879, 1934, 1991, 2046,
...
class 技能2(主动技能):
    ...
    等级精通 = 60
    MP = [23, 241]
    data0 = [int(i*1.0*1.085) for i in [0, 3604, 3968, 4700, 5064, 5431, 5797, 6161, 6527, 6894, 7260, 7624, 7990, 8356, 8721, 9087, 9453, 9817, 10184, 10550, 10914, 11280, 11646, 12013, 12377, 12743, 13109, 13473, 13840, 14206, 14570, 14936, 15303, 15669,
...
class 技能3(主动技能):
    ...
    等级精通 = 60
    MP = [36, 378]
    data0 = [int(i*1.0*1.085) for i in [0, 739, 814, 889, 965, 1039, 1115, 1190, 1265, 1340, 1415, 1489, 1565, 1640, 1716, 1791, 1866, 1942, 2015, 2091, 2166, 2241, 2316, 2392, 2466, 2542, 2617, 2692,
    ...
    hit0 = 2
    data1 = [int(i*1.0*1.085) for i in [0, 2144, 2362, 2580, 2797, 3015, 3233, 3449, 3668, 3885, 4103, 4320, 4539, 4755, 4974, 5191, 5407, 5626, 5844, 6061, 6279, 6497, 6713, 6932, 7150, 7367, 7585, 7802, 8020, 8237,
...
class 技能5(主动技能):
    ...
    MP = [52, 546]
    # 斩击攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 2219, 2444, 2670, 2896, 3122, 3346, 3571, 3797, 4022, 4248, 4472, 4698, 4925, 5150, 5376, 5600, 5825, 6051, 6276, 6500, 6726, 6951, 7178, 7403, 7628, 7853, 8078, 8305, 8530,
...
class 技能6(主动技能):
    ...
    等级精通 = 60
    MP = [52, 546]
    data0 = [int(i*1.0*1.085) for i in [0, 4395, 4841, 5288, 5734, 6180, 6626, 7074, 7517, 7965, 8411, 8857, 9302, 9750, 10195, 10641, 11087, 11534, 11980, 12426, 12871, 13319, 13764, 14210, 14656, 15104, 15548, 15995, 16441,
...
class 技能8(主动技能):
    ...
    等级精通 = 60
    MP = [69, 724]
    data0 = [int(i*1.0*1.085) for i in [0, 1375, 1514, 1653, 1793, 1933, 2072, 2211, 2352, 2490, 2631, 2769, 2909, 3049, 3187, 3329, 3467, 3608, 3747, 3886, 4026, 4165, 4305, 4444, 4583, 4723, 4863, 5002,
...
class 技能9(主动技能):
    ...
    data0 = [int(i*1.0*1.085) for i in [0, 1139, 1255, 1372, 1488, 1603, 1718, 1834, 1950, 2065, 2181, 2297, 2413, 2529, 2644, 2760, 2876, 2991, 3107, 3223, 3339, 3453, 3569, 3686, 3802, 3918, 4033, 4149,
    ...
    hit0 = 5
    data1 = [int(i*1.0*1.085) for i in [0, 2443, 2691, 2940, 3187, 3435, 3684, 3932, 4179, 4428, 4676, 4925, 5171, 5419, 5668, 5915, 6163, 6412, 6659, 6907, 7156, 7404, 7651, 7900, 8148, 8396, 8643, 8891, 9140, 9387,
...
class 技能10(主动技能):
    ...
    # 多段攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 766, 842, 922, 999, 1077, 1155, 1233, 1310, 1388, 1466, 1543, 1622, 1699, 1777, 1855, 1932, 2011, 2090, 2166, 2245, 2321, 2400, 2478, 2555, 2633, 2711, 2789,
    ...
    hit0 = 8
    # 爆炸攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 2163, 2384, 2602, 2821, 3040, 3260, 3480, 3700, 3919, 4139, 4359, 4578, 4798, 5017, 5236, 5457, 5677, 5897, 6115, 6335, 6555, 6776, 6993, 7213, 7433, 7652, 7872, 8091, 8310,
    ...
    def 形态变更(self, 形态, char: Character):
        if 形态 == '' and len(self.形态) > 0:
            形态 = self.形态[0]
        if 形态 == "注能" and '引力源光弹' in char.护石栏:
            self.额外倍率 = 1.3
        else:
            形态 = "常规"
        if 形态 == "常规":
...
class 技能11(主动技能):
    ...
    # 斩击攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 7562, 8329, 9096, 9865, 10632, 11400, 12166, 12933, 13701, 14467, 15236, 16004, 16769, 17537, 18305, 19073, 19840, 20607, 21374, 22141, 22909, 23677, 24445, 25211, 25978, 26746, 27513, 28281,
    ...
    hit0 = 1
    # 能量多段攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 1006, 1108, 1211, 1313, 1416, 1517, 1622, 1725, 1824, 1926, 2030, 2132, 2235, 2337, 2440, 2542, 2645, 2745, 2848, 2950, 3053, 3155, 3258, 3360, 3463, 3565, 3667,
...
class 技能12(主动技能):
    ...
    # 下劈攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 8626, 9501, 10377, 11251, 12127, 13002, 13879, 14753, 15629, 16505, 17379, 18254, 19130, 20005, 20879, 21757, 22630, 23506, 24382, 25257, 26131, 27009, 27882, 28758, 29634, 30509, 31383, 32259,
    ...
    hit0 = 1
    # 上挑攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 13135, 14468, 15801, 17133, 18465, 19799, 21132, 22465, 23798, 25130, 26463, 27796, 29129, 30459, 31794, 33127, 34460, 35792, 37125, 38458, 39791, 41124, 42455, 43787, 45122, 46455, 47786, 49119,
...
class 技能14(主动技能):
    ...
    # 能量多段攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 765, 942, 1120, 1296, 1474, 1653, 1830, 2009, 2183, 2362, 2540, 2718, 2896, 3075, 3250, 3428, 3605,
                                        3784, 3962, 4140, 4316, 4493, 4672, 4850, 5028, 5206, 5381, 5559, 5738, 5915, 6094, 6272, 6448, 6626, 6803, 6981, 7160, 7337, 7515, 7691]]
    hit0 = 14
    # 能量爆炸攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 38996, 48039, 57081, 66124, 75168, 84211, 93255, 102298, 122473, 132423, 142370, 152317, 162264, 172212, 182159, 192106, 202053, 212002,
...
class 技能15(主动技能):
    ...
    # 多段攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 1072, 1181, 1293, 1401, 1509, 1619, 1727, 1836, 1945, 2055, 2164, 2273, 2381, 2491, 2599, 2707, 2817, 2926, 3036, 3144, 3253, 3362, 3471, 3579, 3689, 3798, 3908,
    ...
    hit0 = 10
    data1 = [int(i*1.0*1.085) for i in [0, 4605, 5071, 5538, 6006, 6472, 6941, 7408, 7874, 8342, 8809, 9276, 9743, 10211, 10678, 11145, 11612, 12079, 12548, 13014, 13482, 13948, 14415, 14883, 15349, 15818, 16285, 16751, 17219,
...
class 技能16(主动技能):
    ...
    data0 = [int(i*1.0*1.085) for i in [0, 2255, 2484, 2713, 2941, 3170, 3400, 3630, 3858, 4086, 4315, 4543, 4774, 5002, 5230, 5460, 5688, 5919, 6147, 6376, 6604, 6832, 7061, 7291, 7520, 7749, 7978, 8206, 8437, 8665,
    ...
    hit0 = 10
    data1 = [int(i*1.0*1.085) for i in [0, 9669, 10650, 11631, 12612, 13593, 14575, 15555, 16537, 17517, 18499, 19479, 20460, 21443, 22423, 23404, 24384, 25367, 26347, 27328, 28308, 29290, 30272, 31252, 32234, 33214, 34196, 35177, 36158,
...
class 技能17(主动技能):
    ...
    # 乱舞攻击力：<data0>% X 8次
    data0 = [int(i*1.0*1.085) for i in [0, 4572, 5036, 5502, 5966, 6429, 6893, 7358, 7823, 8287, 8751, 9215, 9679, 10143, 10608, 11071, 11535, 11999, 12464, 12927, 13391, 13855, 14320, 14784, 15247, 15712, 16178, 16642, 17104,
    ...
    hit0 = 8
    # 最后一击攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 15685, 17275, 18867, 20457, 22050, 23640, 25232, 26822, 28416, 30006, 31597, 33188, 34780, 36371, 37962, 39553, 41146, 42737, 44328, 45919, 47511, 49101, 50693, 52283, 53877, 55466, 57058, 58649,
...
class 技能19(主动技能):
    ...
    data0 = [int(i*1.0*1.085) for i in [0, 57209, 63013, 68816, 74622, 80425, 86229, 92033, 97838, 103641, 109445, 115249, 121053, 126857, 132660, 138464, 144269, 150073, 155877, 161679, 167483, 173289, 179093, 184898, 190701, 196505, 202309, 208112, 213917,
...
class 技能20(主动技能):
    ...
    # 多段攻击力：<data0>%
    data0 = [int(i*1.0*1.085) for i in [0, 1260, 1549, 1842, 2136, 2429, 2719, 3012, 3304, 3597, 3889, 4180, 4473, 4765, 5057, 5350, 5644, 5933, 6227, 6520, 6812, 7103, 7396, 7688, 7980, 8273, 8564, 8857, 9148, 9441, 9735,
    ...
    hit0 = 6
    # 爆炸攻击力：<data1>%
    data1 = [int(i*1.0*1.085) for i in [0, 118077, 145459, 172840, 200220, 227602, 254982, 282363, 309745, 337125, 364504, 391886, 419267, 446647, 474029, 501409, 528790, 556172, 583552, 610933, 638314, 665695, 693075, 720456, 747836, 775217, 802599, 829979, 857360, 884741, 912122,
...
class 技能21(主动技能):
    ...
    data0 = [int(i*1.085) for i in [0, 19967, 21992, 24018, 26043, 28069, 30094, 32120, 34146, 36172, 38198, 40224, 42249, 44274, 46300, 48326, 50351, 52377, 54403, 56429, 58455, 60479, 62505, 64531, 66557, 68583, 70608, 72634, 74660, 76686,
    ...
    hit0 = 5
    data1 = [int(i*1.085) for i in [0, 110930, 122182, 133436, 144690, 155944, 167198, 178451, 189705, 200959, 212213, 223467, 234720, 245974, 257228, 268482, 279736, 290989, 302243, 313497, 324751, 336005, 347258, 358512, 369766, 381020, 392274, 403527, 414781,
...
class 技能23(主动技能):
    ...
    data0 = [int(i*1.085) for i in [0, 369810, 455564, 541317, 627071, 712824, 798578, 884331, 970084, 1055838, 1141590, 1227345, 1313097, 1398851, 1484604, 1570358, 1656111, 1741864, 1827618, 1913372, 1999125, 2084878, 2170632, 2256385, 2342139, 2427891, 2513645, 2599398, 2685152, 2770905,
